...
using HRSkill.Dialogs.ChangeAddress;
...
namespace HRSkill.Dialogs.Main
{
    public class MainDialog : RouterDialog
    {
        ...
        protected override async Task RouteAsync(DialogContext dc, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            localeConfig.LuisServices.TryGetValue("hrskill", out var luisService);
            ...
            else
            {
                ...
                var result = await luisService.RecognizeAsync<HRSkillLU>(dc.Context, CancellationToken.None);
                ...
                switch (intent)
                {
                    ...
                    case HRSkillLU.Intent.GetPayslip:
                        {
                            await dc.Context.SendActivityAsync("Payslip functionality coming soon!");
                            if (_skillMode)
                            {
